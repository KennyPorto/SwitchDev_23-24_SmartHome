...
{
    public SolarIrradianceSensor(DeviceID deviceID, SensorName name, SensorId sensorID, SensorTypeId sensorTypeId,
    ...
    public boolean sameAs(Object o)
    {
        ...
        SolarIrradianceSensor that = (SolarIrradianceSensor) o;
