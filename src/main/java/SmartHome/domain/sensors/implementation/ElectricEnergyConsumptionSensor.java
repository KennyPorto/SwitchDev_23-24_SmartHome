...
public class ElectricEnergyConsumptionSensor extends Sensor
{
    ...
    public ElectricEnergyConsumptionSensor(DeviceID deviceID, SensorName name, SensorId sensorID,
    ...
    public boolean sameAs(Object o)
    {
        ...
        ElectricEnergyConsumptionSensor that = (ElectricEnergyConsumptionSensor) o;
